...
/*! \fn void ShowConsoleCursor(int showFlag)
    \brief Funkcja zmieniaj¹ca widocznoœæ kursora.
    \param showFlag Parametr widocznoœci kursora
    \return Funkcja nic nie zwraca. */
void ShowConsoleCursor(int showFlag);

/*! \fn void gotoxy(int x, int y)
    \brief Funkcja zmieniaj¹ca pozycjê kursora.
...
/*! \fn void arrowsHandling(int* x, int* y, int c, int maxx, int maxy, int minx, int miny)
    \brief Funkcja obs³uguj¹ca sterowanie kursorem za pomoc¹ strza³ek.
...
/*! \fn bool isValid(int x, int y, int rows, int columns)
